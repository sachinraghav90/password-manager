...
import { Shield, FileText, CreditCard, Menu, X, Sun, Moon, LogOut, LayoutGrid, Star, ChevronDown, Plus, Lock, Settings as SettingsIcon, User, Users, Share2 } from 'lucide-react';
